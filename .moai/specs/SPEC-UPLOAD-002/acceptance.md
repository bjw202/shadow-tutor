...
| 항목 | 기준 | 상태 |
|------|------|------|
| 탭 전환 기능 | 정상 동작 | Pending |
| 텍스트 입력 | 정상 동작 | Pending |
| 문자 수 카운터 | 실시간 업데이트 | Pending |
| 세그먼트 파싱 | 문장 단위 분할 | Pending |
| 페이지 이동 | 연습 페이지 정상 이동 | Pending |

### 테스트 커버리지 기준

| 항목 | 목표 | 상태 |
|------|------|------|
| 단위 테스트 | 90% 이상 | Pending |
| 통합 테스트 | 4개 시나리오 | Pending |
| E2E 테스트 | 주요 플로우 | Pending |

### 접근성 기준

| 항목 | 기준 | 상태 |
|------|------|------|
| 키보드 네비게이션 | Tab/Enter 지원 | Pending |
| ARIA 레이블 | 모든 인터랙티브 요소 | Pending |
| 색상 대비 | WCAG AA 준수 | Pending |

### 성능 기준

| 항목 | 기준 | 상태 |
|------|------|------|
| 탭 전환 응답 | 100ms 이하 | Pending |
| 텍스트 입력 반응 | 16ms 이하 (60fps) | Pending |
| 페이지 이동 | 500ms 이하 | Pending |
